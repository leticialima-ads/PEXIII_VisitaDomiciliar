...
class FiltrosScreen extends StatefulWidget {
  ...
  @override
  State<FiltrosScreen> createState() =>
      _FiltrosScreenState();
}

class _FiltrosScreenState
    extends State<FiltrosScreen> {
  String _filtroAtual = 'todos';
  ...
  List<Paciente> _filtrarPacientes(
    ...
    switch (_filtroAtual) {
      ...
      case 'preventivo':
        return provider
            .getMulheresSemPreventivo();

      case 'criancas':
        return provider
            .getCriancasCadernetaAtrasada();

      case 'vasectomia':
        return provider
            .getHomensInteresseVasectomia();
